...
export class ScoreFeedbackComponent {
    ...
    open_json_feedback_statements_dialog (): void {
      this.results_viewer_dialog_service.open_dialog (this._dialog, this._json_feedback_statements);
    }
    ...
    open_json_scores_list_dialog (): void {
      this.results_viewer_dialog_service.open_dialog (this._dialog, this._json_scores_list);
    }
